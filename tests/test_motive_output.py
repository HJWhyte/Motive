...
def test_motive_output_success():
    ...
    client.post(f"/vote/{name}?motive_name={name}&username={username1}&availability={availability1[0]}&availability={availability1[1]}")
    ...
    ### TODO Add test to check votes is an integer 